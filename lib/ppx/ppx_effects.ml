...
let try_with_ident ~loc =
  loca ~loc @@ Ppxlib.Longident.parse "EffectHandlers.Deep.try_with"

let continue_ident ~loc =
  loca ~loc @@ Ppxlib.Longident.parse "EffectHandlers.Deep.continue"

let continuation_ident ~loc =
  loca ~loc @@ Ppxlib.Longident.parse "EffectHandlers.Deep.continuation"
